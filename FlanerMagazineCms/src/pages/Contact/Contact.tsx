...
const Contact = () => {
  ...
  return (
    ...
    >
      <aside
        className={`flex-shrink-0 w-64 flex flex-col border-r transition-all duration-300 border-black h-screen overflow-y-auto  ${
          sidebarOpen ? "" : "-ml-64"
        }`}
      >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 py-8 lg:py-16 mt-12">
            ...
            <div className="text-center lg:text-left">
              <div className="mt-8 text-xl lg:text-2xl font-semibold">
                <span className="font-bold">Вероніка Мартинова —</span> <br />
          ...
          <div className="mt-12">
            ...
            <div className="flex items-center justify-center gap-12 md:gap-24 lg:gap-32 mt-10">
              <div className="text-4xl sm:text-5xl lg:text-6xl">
                <Link
                  to={
                    "https://www.instagram.com/kflaner?igsh=MXBwYmZyamc1bTdjcA%3D%3D&utm_source=qr"
                  }
                >
                  {" "}
                  <AiFillInstagram />
              ...
              <div className="text-4xl sm:text-5xl lg:text-6xl">
                <Link
                  to={
                    "https://www.facebook.com/share/Lq62N2EeNLPT7o51/?mibextid=LQQJ4d"
                  }
                >
                  <FaFacebook />
                </Link>
