...
PRODUCT_NOT_FOUND_RESPONSE: OpenAPIResponseType = {
    status.HTTP_404_NOT_FOUND: {
        ...
        "model": ErrorModel,
        "content": {
            "application/json": {"example": {"detail": ProductError.NOT_FOUND}}
        },
    }
}
