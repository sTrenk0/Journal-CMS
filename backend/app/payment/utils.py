...
def verify_payment_hook(x_sign_base64: str, body: dict) -> bool:
    try:
        ...
        pub_key.verify(signature_bytes, body_bytes, sigdecode=ecdsa.util.sigdecode_der, hashfunc=hashlib.sha256)
        return True
    except BadSignatureError:
        return False


def check_on_data_relevance(requested_modified_date: str, stored_modified_date: str) -> bool:
